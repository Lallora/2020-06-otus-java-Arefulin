...
import ru.otus.atm.cash_vault.operations.interfaces.IIssueBills;
...
public class IssueBills implements IIssueBills {
    ...
    public static int execute(ServiceTuple serviceTuple) {
        ...
        for (int i = 0, listOfCellsWithBanknotesSize = serviceTuple.listCellsWithBanknotes.size(); i < listOfCellsWithBanknotesSize; i++) {
            ...
            ToConsole.print(serviceTuple.executionControl, billNumber + "/" + tempExistCount + " bills of " +
